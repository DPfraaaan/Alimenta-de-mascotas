...
static void read_weight(void)
{
    HX711_init(GPIO_DATA, GPIO_SCLK, GAIN); 
    HX711_tare();
...
// Función de interrupción para temporizador
void temporizador_callback(void* arg)
{
...
// Configuración del temporizador hardware
...
void configurar_temporizadores_servo() {
